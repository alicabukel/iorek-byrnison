...
PIPELINE_IMAGE = 'gcr.io/qwiklabs-gcp-01-868d72e03fcc/tc_img_tfx:latest'
...
_query_sample_rate = 1 #0.0001  # Generate a 0.01% random sample.
...
BIG_QUERY_QUERY = """
         SELECT
                ...
                MonthlyCharges,
                TotalCharges,
                IF(Churn = 'Yes', 1, 0) AS Churn
         FROM `qwiklabs-gcp-01-868d72e03fcc.iorek_byrnison.telco_churn_1m_new_TVT`
         WHERE (ABS(FARM_FINGERPRINT(CAST(customerID AS STRING))) / 0x7FFFFFFFFFFFFFFF)
